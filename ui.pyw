...
class main_wx(wx.Frame):
    ...
    def __set_properties(self):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(wx.Bitmap("./res/icon.png", wx.BITMAP_TYPE_ANY))
        self.SetIcon(_icon)
        self.button_quit.SetBitmap(wx.Bitmap("./res/error_small.png", wx.BITMAP_TYPE_ANY))
        self.button_check.SetBitmap(wx.Bitmap("./res/check_small.png", wx.BITMAP_TYPE_ANY))
    ...
    def __do_layout(self):
        ...
        bitmap_1 = wx.StaticBitmap(self.notebook_1_About, wx.ID_ANY, wx.Bitmap("./res/about.png", wx.BITMAP_TYPE_ANY))
...
class event_wx(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.button_2.SetBitmap(wx.Bitmap("res\\error_small.png", wx.BITMAP_TYPE_ANY))
